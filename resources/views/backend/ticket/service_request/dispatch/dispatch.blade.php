    ...
    <div class="page-content" style="background-color: aliceblue;">
        ...
        <div>
            <button type="button" class="btn btn-primary btn-icon-text" data-bs-toggle="modal"
                ...
                <i class="btn-icon-prepend" data-feather="plus"></i>Add Dispatch
            </button>
        </div>
        <br>
        {{-- Body --}}
                            ...
                            <table id="dataTableExample1" class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="color: gray;">Bank Docket No</th>
                                        <th style="color: gray;">Bank Name</th>
                                        ...
                                        <th style="color: gray;">Dispatch Date</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($combine_array as $key => $item)
                                        <tr>
                                            ...
                                            <td style="color: black;">{{ $item->bank_docket_no }}</td>
                                            <td style="color: black;">{{ $item->bank_name }}</td>
                                            <td style="color: black;">{{ $item->created_date }}</td>
                                            ...
                                            <td style="color: black;">{{ $item->dispatch_date }}</td>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="background-color: aliceblue;">
                <div class="modal-header">
                    <h5 class="modal-title" id="varyingModalLabel" style="color: black;">Add Dispatch</h5>
                    ...
                    <form id="myForm" method="POST" action="{{ route('store.followup') }}" class="forms-sample">
                        <div class="row">
                            ...
                            <div class="mb-3 form-group col-md-6">
                                <label for="exampleInputEmail1" class="form-label" style="color: gray;">Docket
                                    No<span>*</span></label>
                                <input type="number" name="docket_no" class="form-control"
                                    style="color: black;background-color:aliceblue" required>
                            </div>
                            <div class="mb-3 form-group col-md-6">
                                <label for="exampleInputEmail1" style="color: gray;" class="form-label">Ticket
                                    Name<span>*</span></label>
                                <select name="tickets_id" style="background-color: aliceblue; color:black"
                        ...
                        <div class="row">
                            <div class="mb-3 form-group col-md-6">
                                <label for="exampleInputEmail1" class="form-label" style="color: gray;">Call
                                    Date<span>*</span></label>
                                <input type="date" name="call_date" class="form-control"
                                    style="color: black;background-color:aliceblue" required>
                            </div>
                            <div class="mb-3 form-group col-md-6">
                                <label for="exampleInputEmail1" class="form-label" style="color: gray;">Bank Docket
                                    No<span>*</span></label>
                                <input type="number" name="bank_docket_no" class="form-control"
                                    style="color: black;background-color:aliceblue" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 form-group col-md-6">
                                <label for="exampleInputEmail1" class="form-label" style="color: gray;">Created
                                    Date<span>*</span></label>
                                <input type="date" name="created_date" class="form-control"
                                    style="color: black;background-color:aliceblue" required>
                            </div>
                            <div class="mb-3 form-group col-md-6">
                                <label for="exampleInputEmail1" class="form-label" style="color: gray;">Bank
                                    Name<span>*</span></label>
                        ...
                        <div class="row">
                            <div class="mb-3 form-group  col-md-6">
                                <label for="exampleInputEmail1" class="form-label" style="color: gray;">Site
                                    ID<span>*</span></label>
                            ...
                            <div class="mb-3 form-group  col-md-6">
                                <label for="exampleInputEmail1" class="form-label"
                                    style="color: gray;">Vendor<span>*</span></label>
                                <select style="color: black;background-color:aliceblue"
                                    class="js-example-basic-single form-select select2-hidden-accessible" name="vendor"
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 form-group col-md-6">
                                ...
                                <select style="color: black;background-color:aliceblue"
                                    class="js-example-basic-single form-select select2-hidden-accessible" name="call_type"
                                    data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true" required>
                                    <option value="Incoming" data-select2-id="3">In Coming</option>
                                    <option value="Outgoing" data-select2-id="13">Out Going</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="mb-3 form-group col-md-6">
                                <label for="exampleInputEmail1" class="form-label" style="color: gray;">Sub Call
                                    Type<span>*</span></label>
                                <select style="color: black;background-color:aliceblue"
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 form-group col-md-6">
                                <label for="exampleInputEmail1" class="form-label" style="color: gray;">Sub
                                    Status<span>*</span></label>
                                <select style="color: black;background-color:aliceblue"
                                    class="js-example-basic-single form-select select2-hidden-accessible"
                                    name="sub_status" data-width="100%" data-select2-id="1" tabindex="-1"
                                    aria-hidden="true" required>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 form-group col-md-6">
                                <label class="form-label" style="color: gray;">Dispatch Date<span>*</span></label>
                                <input type="date" name="dispatch_date" class="form-control"
                                    style="color: black;background-color:aliceblue" required>
                            </div>
                        </div>
                        <div class="mb-3 form-group">
                            <label for="exampleInputEmail1" class="form-label" style="color: gray;">Action
                                Taken<span>*</span></label>
                            <textarea type="text" name="action_taken" class="form-control" style="color: black;background-color:aliceblue"
                                required></textarea>
                        </div>
